...
function HeadImage(className) {
	...
	this.setImageDirection = function() {
		...
		} else if (mouseX >= this.imageLeft && mouseX <= this.imageRight
				&& mouseY >= this.imageBottom) {
